...
rules_responses = {
    ...
    r'rules': 'The rules and regulations for mining in India are primarily outlined in the Mines and Minerals (Development and Regulation) Act, 1957. This includes guidelines on grant of leases, royalty rates, and environmental clearances.',
    ...
    r'environmental impact': 'Mining activities in India are subject to environmental regulations. The Environmental Impact Assessment (EIA) process is crucial for obtaining clearances. It assesses and mitigates potential environmental impacts.',
    r'foreign investment': 'Foreign investment in mining projects is regulated by the Foreign Exchange Management Act (FEMA) and is subject to government approval. Specific guidelines exist to govern the participation of foreign entities in the mining sector.',
    r'safety measures': 'Safety measures for mining operations in India are mandated under the Mines Act, 1952. These measures include provisions for the health and safety of workers, prevention of accidents, and emergency response planning.',
    ...
    r'small-scale mining': 'Artisanal and small-scale mining in India is governed by specific guidelines that aim to regulate and support these activities. The Ministry of Mines has issued guidelines to ensure responsible and sustainable practices.',
    ...
    r'royalty calculation': 'Royalty for minerals extracted during mining is calculated based on the specific mineral, its grade, and the method of extraction. The rates are determined by the government and are subject to periodic revisions.',
    ...
    r'dispute resolution': 'Disputes related to mining leases are typically resolved through legal mechanisms, including arbitration and the judiciary. The Mines and Minerals (Development and Regulation) Act provides a framework for dispute resolution.',
    ...
    r'illegal mining': 'Preventing illegal mining involves strict enforcement by state authorities, use of technology for monitoring, and community involvement. Penalties for illegal mining are defined in the Mines and Minerals (Development and Regulation) Act.',
    r'use-it-or-lose-it': 'The "use-it-or-lose-it" principle implies that mining leaseholders must actively engage in mining activities. Failure to do so may result in the cancellation or non-renewal of the mining lease.',
    ...
    r'auction process': 'Mineral blocks are auctioned through a transparent process outlined by the government. The auction process involves competitive bidding, and successful bidders are granted mining leases.',
    r'penalties': 'Penalties for non-compliance with mining regulations in India can include fines, suspension of mining activities, or cancellation of mining leases. The specific penalties are outlined in the Mines and Minerals (Development and Regulation) Act.',
    r'mining rights': 'Mining rights generally refer to the legal authority to extract minerals, while mining leases provide exclusive rights for a specified area and duration. Both are governed by the Mines and Minerals (Development and Regulation) Act.',
    ...
    r'digital initiatives': 'Digital initiatives in the mining sector include the use of technology for data management, monitoring, and automation. These initiatives aim to enhance efficiency, transparency, and decision-making.',
    ...
    r'tax incentives': 'Tax incentives or exemptions for mining companies may be provided by the government to encourage investments. These incentives could include reduced tax rates, depreciation benefits, or exemptions on specific transactions.',
    ...
    r'state government role': 'State governments play a crucial role in regulating mining activities within their jurisdiction. They grant leases, monitor compliance, and may have specific regulations tailored to regional needs.',
    r'environmental impact assessments': 'Environmental Impact Assessments (EIAs) for mining projects involve a comprehensive study of potential environmental impacts. These assessments are critical for obtaining environmental clearances and ensuring sustainable mining practices.',
    r'precious stones': 'Regulations for the mining of precious stones, such as diamonds and emeralds, include guidelines for exploration, extraction, and trade. These regulations aim to prevent illegal trade and promote ethical practices.',
...
def mining_rules_bot(user_input):
    """Processes user input and returns matching responses."""
...
if user_input:  # Ensure user_input is defined before calling the function
    responses = mining_rules_bot(user_input)  # Pass user_input directly
        # Create the Streamlit app

# Option 1: Use st.selectbox (no sidebar)
keywords_list = list(rules_responses.keys())
with st.sidebar:
    st.subheader("Select a Keyword")
    st.selectbox("", keywords_list, disabled=False)
if user_input and isinstance(user_input, str):
        if isinstance(user_input, str):  # Check if it's a string
            responses = mining_rules_bot(user_input)
            for i, response in enumerate(responses):
                bot_history = f"Chatbot: {response}"
                message("You: " + user_input)  # Display user input first
                message(bot_history)
        else:
                message("I didn't understand. Kindly try again")
